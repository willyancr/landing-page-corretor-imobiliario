    ...
    <div className="h-screen bg-zinc-950 bg-home bg-no-repeat text-zinc-50">
      ...
      <main className="mx-auto flex w-full max-w-[1600px] flex-col gap-10 px-12 pt-10">
        <div className="flex items-center gap-20">
          <h1 className="flex-1 text-5xl font-bold leading-tight">
            O melhor lugar para encontrar a{" "}
            <span className="text-primary">casa dos seus sonhos</span>
          </h1>
          <div className="flex-1 space-y-6 px-5">
            ...
            <button className="flex items-center gap-1 rounded-lg bg-primary px-4 py-2 font-medium text-zinc-50 shadow-md transition-all hover:brightness-75">
              Entre em contato
            </button>
            <div className="flex gap-12">
              ...
              <div className="flex flex-col">
                <p className="text-lg font-semibold">
                  09<span className="text-primary">+</span>
                </p>
