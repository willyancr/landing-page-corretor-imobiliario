...
export default function ContentAbout() {
  ...
  <section className="w-full bg-greyGeometry px-4 py-12 md:px-12">
    {data?.map((item, index) => (
      <div
        key={index}
        className="mx-auto flex flex-col-reverse md:flex-row max-w-[1200px] items-center gap-10 md:gap-20"
      >
        <div className="flex flex-1 flex-col gap-5 md:gap-10">
          <h1 className="font-CoHeadlineBold text-4xl md:text-5xl font-bold text-primary lg:text-6xl">
            Artur Ribeiro
          </h1>
          <p className="text-2xl md:text-3xl font-bold">Sobre mim</p>
